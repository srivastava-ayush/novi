  ...
  return (
    <section className="relative pt-8 pb-12 px-6 overflow-hidden bg-background">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* Dark Sleek CTA Banner Matching Homepage Theme */}
        <div className="relative rounded-3xl overflow-hidden border border-black/5 dark:border-white/10 bg-[#0c0a1f] text-white shadow-2xl">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center p-6 sm:p-12 relative z-10">
            ...
            {/* Right Column: Heading, Subtitle, Parent Action Buttons & Checklist */}
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h3 
                className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-indigo-300 to-cyan-400"
                style={{ fontFamily: "var(--font-display)" }}
              >
                Meet Novi today.
              </h3>

              {/* Action Buttons (Kept for Parents) */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/50">
                <li><Link href="/#how-it-works" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">How It Works</Link></li>
                <li><Link href="/#for-students" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Career Explorer</Link></li>
                <li><Link href="/#universities" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">University Explorer</Link></li>
                <li><Link href="/coming-soon" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">AI Roadmap</Link></li>
                <li><Link href="/coming-soon" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Career Passport</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/50">
                <li><Link href="/for-parents" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Parent Dashboard</Link></li>
                <li><Link href="/for-parents" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">How We Help</Link></li>
                <li><Link href="/for-parents" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Resources</Link></li>
                <li><Link href="/for-parents" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Guides</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/50">
                <li><Link href="/#about-us" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">About Us</Link></li>
                <li><Link href="/coming-soon" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Blog</Link></li>
                <li><Link href="/careers" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Careers</Link></li>
                <li><Link href="/coming-soon" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Contact Us</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/50">
                <li><Link href="/coming-soon" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Privacy Policy</Link></li>
                <li><Link href="/coming-soon" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Terms of Service</Link></li>
                <li><Link href="/coming-soon" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Cookie Policy</Link></li>
              </ul>
            </div>

          </div>

          {/* Stay updated with Novi (Bottom Left as in screenshot) */}
