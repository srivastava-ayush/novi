          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center p-6 sm:p-12 relative z-10">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <p className="text-sm sm:text-base text-purple-300 font-medium">
                Meet Novi—the AI mentor that helps students find direction while keeping their goals in sight.
              </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/50">
                <li><Link href="/for-students" className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors">How It Works</Link></li>
