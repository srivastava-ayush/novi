    ...
    <section className="relative py-20 px-6 overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto relative z-10 text-center space-y-12">
        ...
        <div className="max-w-3xl mx-auto space-y-3">
          ...
          >
            Novi understands you better over time.
          </h2>
          <p className="text-sm sm:text-base text-foreground/70 leading-relaxed">
            Your interests, strengths, experiences and goals come together to create a profile that grows with you — and gets smarter over time.
          </p>
        </div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="p-6 sm:p-8 rounded-3xl bg-surface/70 dark:bg-surface-elevated/40 border border-foreground/10 shadow-xl overflow-x-auto"
        >
          <div className="flex items-center justify-between min-w-max py-2 gap-2 sm:gap-4">
            {nodes.map((node) => {
